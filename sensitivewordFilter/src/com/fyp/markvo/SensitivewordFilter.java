...
public class SensitivewordFilter  implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7981778703014692817L;
	...
	public static void main(String[] args) {
		...
		SensitivewordFilter filter =  new SensitivewordFilter("d:/SensitiveWord - 副本.txt");
		System.out.println("敏感词的数量：" + filter.sensitiveWordMap.size());
		String string = "太多的伤感情怀也许只局限于饲养基地 荧幕中的情节，主人公尝试着去用某种方式渐渐的很潇洒地释自杀指南怀那些自己经历的伤感。"
						+ "然后法轮功 我们的扮演的角色就是跟随着主人公的喜红客联盟 怒哀乐而过于牵强的把自中国人己的情感也附加于银幕情节中，然后感动就流泪，"
